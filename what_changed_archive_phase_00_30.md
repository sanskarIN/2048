...
- **License:** MIT
- **Current phase:** Phase 30 — guarded release-qualification evidence recorder implemented, formatted, regression-tested in source, documented, and added to the continuity log; the latest previously accepted full CI/native evidence remains the Phase 29 Version 1.5 baseline until a newer maintained workflow result is explicitly recorded; the stable qualification boundary remains 0/13 and GitHub issues #10 and #12 remain explicit
