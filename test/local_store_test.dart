...
void main() {
  ...
  test('persists daily challenge history', () async {
    ...
    final dailyState = GameState(
      ...
      config: const GameConfig(mode: GameMode.daily, size: 4, seed: 20260814),
      score: 1024,
      moves: 90,
    );
  ...
  test(
    ...
    () async {
      SharedPreferences.setMockInitialValues({
        'nova.daily_history.v1': '[{"seed":20260814,"score":128,"moves":12,"highestTile":64,"completed":false,"won":false,"updatedAt":"2026-08-14T00:00:00.000Z"},{"seed":20260230,"score":999},{"seed":20260813,"score":64,"moves":8,"highestTile":32,"completed":false,"won":false,"updatedAt":"2026-08-13T00:00:00.000Z"}]',
      });
      final store = LocalStore();
  ...
  test(
    ...
    () async {
      ...
      expect(
        records.single.updatedAt,
        DateTime.parse('2026-08-14T02:00:00.000Z'),
      );
