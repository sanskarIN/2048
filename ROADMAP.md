...
- Expanded automated engine, persistence, controller, interaction, session-integrity, accessibility, Auto Play isolation, and replay-timeline tests.
...
- Replay export/import or a separate full-session replay format beyond the current bounded Undo-backed viewer.
- Save export/import with schema/version validation and explicit replacement confirmation.
