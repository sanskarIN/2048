const hindiTranslations = <String, String>{
  ...
  'QR code containing this challenge code': 'इस चैलेंज कोड वाला QR कोड',
  ...
  'Home can open Game Backup to copy one validated current-game JSON backup to the clipboard, save the same backup as a .nova2048 file, or restore a valid backup from either transport after explicit confirmation. Portable backup excludes settings, lifetime statistics, achievements, Daily history, and old Undo history. Every imported game is deliberately marked unranked, stays unranked after restart, and cannot change lifetime records, achievements, streaks, or Daily results. Imported play can still save and create new Undo snapshots for that restored session.':
      'Home से Game Backup खोलकर एक सत्यापित वर्तमान-गेम JSON बैकअप क्लिपबोर्ड पर कॉपी किया जा सकता है, उसी बैकअप को .nova2048 फ़ाइल के रूप में सेव किया जा सकता है, या स्पष्ट पुष्टि के बाद किसी भी माध्यम से वैध बैकअप रिस्टोर किया जा सकता है। पोर्टेबल बैकअप में सेटिंग्स, लाइफटाइम आँकड़े, उपलब्धियाँ, Daily history और पुरानी Undo history शामिल नहीं होती। हर इम्पोर्ट किया गया गेम जानबूझकर अनरैंक्ड चिह्नित होता है, रीस्टार्ट के बाद भी अनरैंक्ड रहता है और लाइफटाइम रिकॉर्ड, उपलब्धियाँ, स्ट्रीक या Daily परिणाम नहीं बदल सकता। इम्पोर्ट किए गए गेम में बाद की चालें सेव हो सकती हैं और उसी रिस्टोर किए गए सेशन के लिए नई Undo snapshots बन सकती हैं।',
};
